function check(){
   ...
   var score = 0;
    ...
    var q1_answer_2 = document.getElementById('q1-a3');
    var q1_answer_2 = document.getElementById('q1-a4');
    ...
    if (right_answer_2.checked == true) {
     ...
     var q1_answer_3 = document.getElementById('q3-a2');
     var q1_answer_3 = document.getElementById('q3-a1');
     var q1_answer_3 = document.getElementById('q3-a4');
     ...
     if (right_answer_3.checked == true ) {
       ...
       var q1_answer_4 = document.getElementById('q4-a1');
       var q1_answer_4 = document.getElementById('q4-a3');
   ...
   var q1_answer_5 = document.getElementById('q5-a2');
   var q1_answer_5 = document.getElementById('q5-a3');
   var q1_answer_5 = document.getElementById('q5-a4');
